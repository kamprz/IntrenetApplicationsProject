...
import wat.semestr8.tim.security.filter.JWTAuthenticationFilter;
import wat.semestr8.tim.security.filter.JWTAuthorizationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/concert/seats*").permitAll()
                ...
                .antMatchers("/populate").hasAuthority(SecurityAuthorities.ADMIN)
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        config.addAllowedHeader("Access");
